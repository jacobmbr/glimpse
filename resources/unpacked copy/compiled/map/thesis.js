...
goog.addDependency("../thesis/map/handlers.js", ['thesis.map.handlers'], ['chromex.ext.runtime', 'chromex.protocols', 'reagent.core', 'goog.Uri', 'cljs.core', 'chromex.support', 'chromex.logging', 'clojure.string', 'chromex.ext.storage', 'thesis.background.storage', 're_frame.core']);
goog.addDependency("../thesis/map/subs.js", ['thesis.map.subs'], ['cljs.core', 'chromex.logging', 'clojure.string', 're_frame.core']);
...
goog.addDependency("../thesis/map/gui.js", ['thesis.map.gui'], ['domina.core', 'goog.string', 'thesis.map.handlers', 'reagent.core', 'cljs.core', 'chromex.logging', 'cljs.core.async', 'thesis.map.subs', 'domina.events', 'cljs_idxdb.core', 'clojure.string', 'thesis.content_script.animation', 're_frame.core']);
...
goog.addDependency("../thesis/map/core.js", ['thesis.map.core'], ['chromex.ext.runtime', 'thesis.map.gui', 'chromex.protocols', 'thesis.map.handlers', 'cljs.core', 'chromex.support', 'chromex.logging', 'cljs.core.async', 'thesis.map.subs', 'dirac.runtime', 'devtools.core']);
goog.addDependency("../thesis/map.js", ['thesis.map'], ['thesis.map.core', 'cljs.core']);

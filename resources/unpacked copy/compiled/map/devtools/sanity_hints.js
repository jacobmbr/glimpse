...
var map__34653 = top_item;
var map__34653__$1 = ((((!((map__34653 == null)))?((((map__34653.cljs$lang$protocol_mask$partition0$ & (64))) || (map__34653.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__34653):map__34653);
...
}catch (e34652){var _e = e34652;
return false;
}});
devtools.sanity_hints.type_error_to_string = (function devtools$sanity_hints$type_error_to_string(self){
var temp__4655__auto___34655 = devtools.sanity_hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___34655)){
var seen_errors_34656 = temp__4655__auto___34655;
if(cljs.core.truth_(seen_errors_34656.has(self))){
} else {
seen_errors_34656.add(self);

var temp__4657__auto___34657 = devtools.sanity_hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___34657)){
var sense_34658 = temp__4657__auto___34657;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_34658)].join('');
} else {
}
}
} else {

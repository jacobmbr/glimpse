...
var args33314 = [];
var len__19487__auto___33318 = arguments.length;
var i__19488__auto___33319 = (0);
while(true){
if((i__19488__auto___33319 < len__19487__auto___33318)){
args33314.push((arguments[i__19488__auto___33319]));

var G__33320 = (i__19488__auto___33319 + (1));
i__19488__auto___33319 = G__33320;
continue;
} else {
}
break;
...
var handler_fn = cljs.core.get.call(null,cljs.core.deref.call(null,re_frame.subs.key__GT_fn),key_v);
if(goog.DEBUG){
var temp__4657__auto___33322 = cljs.core.seq.call(null,cljs.core.remove.call(null,((function (key_v,handler_fn){
return (function (p1__33313_SHARP_){
if(!((p1__33313_SHARP_ == null))){
if((false) || (p1__33313_SHARP_.reagent$ratom$IReactiveAtom$)){
return true;
} else {
return false;
}
...
,dynv));
if(temp__4657__auto___33322){
var not_reactive_33323 = temp__4657__auto___33322;
re_frame.utils.warn.call(null,"re-frame: dynv contained parameters that don't implement IReactiveAtom: ",not_reactive_33323);
} else {
}
} else {
}

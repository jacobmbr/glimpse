...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__19023__auto__,writer__19024__auto__,opt__19025__auto__){
return cljs.core._write.call(null,writer__19024__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__31739 = o;
(G__31739[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__31740__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__31740 = function (var_args){
var args = null;
...
while (G__31741__i < G__31741__a.length) {G__31741__a[G__31741__i] = arguments[G__31741__i + 0]; ++G__31741__i;}
  args = new cljs.core.IndexedSeq(G__31741__a,0);
} 
return G__31740__delegate.call(this,args);};
G__31740.cljs$lang$maxFixedArity = 0;
G__31740.cljs$lang$applyTo = (function (arglist__31742){
var args = cljs.core.seq(arglist__31742);
return G__31740__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__18405__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__18405__auto__){
var and__18405__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__18405__auto____$1){
var and__18405__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__31747 = jsprops;
(G__31747["defaultValue"] = value);

(G__31747["onChange"] = ((function (G__31747,v,value,on_change){
return (function (p1__31745_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__31745_SHARP_);
});})(G__31747,v,value,on_change))
);
...
var vec__31752 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__31752,(0),null);
var id = cljs.core.nth.call(null,vec__31752,(1),null);
var class$ = cljs.core.nth.call(null,vec__31752,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___31755 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___31755 == null)){
} else {
var key_31756 = temp__4661__auto___31755;
(jsprops["key"] = key_31756);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__31758 = (new reagent.impl.template.NativeWrapper());
(G__31758["name"] = c);
...
var len__19487__auto___31764 = arguments.length;
var i__19488__auto___31765 = (0);
while(true){
if((i__19488__auto___31765 < len__19487__auto___31764)){
args__19494__auto__.push((arguments[i__19488__auto___31765]));

var G__31766 = (i__19488__auto___31765 + (1));
i__19488__auto___31765 = G__31766;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__19495__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq31762){
var G__31763 = cljs.core.first.call(null,seq31762);
var seq31762__$1 = cljs.core.next.call(null,seq31762);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__31763,seq31762__$1);
});
...
break;
default:
var G__31770 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__31770;
continue;
...
var n__19332__auto___31771 = a.length;
var i_31772 = (0);
while(true){
if((i_31772 < n__19332__auto___31771)){
(a[i_31772] = reagent.impl.template.as_element.call(null,(a[i_31772])));

var G__31773 = (i_31772 + (1));
i_31772 = G__31773;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__19332__auto___31774 = a.length;
var i_31775 = (0);
while(true){
if((i_31775 < n__19332__auto___31774)){
var val_31776 = (a[i_31775]);
if((cljs.core.vector_QMARK_.call(null,val_31776)) && ((reagent.impl.template.key_from_vec.call(null,val_31776) == null))){
(o["no-key"] = true);
} else {
}

(a[i_31775] = reagent.impl.template.as_element.call(null,val_31776));
...
var ctx = {};
var vec__31779 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__31779,(0),null);
var derefed = cljs.core.nth.call(null,vec__31779,(1),null);
...
var G__31781 = (cljs.core.count.call(null,argv) - first_child);
switch (G__31781) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__31781){

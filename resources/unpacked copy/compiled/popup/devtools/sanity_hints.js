...
var file = cljs.core.get.call(null,map__24641__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__24641__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__24641__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.sanity_hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e24640){var _e = e24640;
return false;
}});
devtools.sanity_hints.type_error_to_string = (function devtools$sanity_hints$type_error_to_string(self){
var temp__4655__auto___24643 = devtools.sanity_hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___24643)){
var seen_errors_24644 = temp__4655__auto___24643;
if(cljs.core.truth_(seen_errors_24644.has(self))){
} else {
seen_errors_24644.add(self);

var temp__4657__auto___24645 = devtools.sanity_hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___24645)){
var sense_24646 = temp__4657__auto___24645;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_24646)].join('');
} else {
}
}
} else {

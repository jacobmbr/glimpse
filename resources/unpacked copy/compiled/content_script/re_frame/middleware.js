...
while (G__16422__i < G__16422__a.length) {G__16422__a[G__16422__i] = arguments[G__16422__i + 0]; ++G__16422__i;}
  args = new cljs.core.IndexedSeq(G__16422__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__16423){
var args = cljs.core.seq(arglist__16423);
...
return cljs.core.get_in.call(null,new_db,p1__16451_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__16452_SHARP_){
return cljs.core.get_in.call(null,db,p1__16452_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
while (G__16456__i < G__16456__a.length) {G__16456__a[G__16456__i] = arguments[G__16456__i + 2]; ++G__16456__i;}
  in_paths = new cljs.core.IndexedSeq(G__16456__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__16461){
var f = cljs.core.first(arglist__16461);
arglist__16461 = cljs.core.next(arglist__16461);
var out_path = cljs.core.first(arglist__16461);
var in_paths = cljs.core.rest(arglist__16461);

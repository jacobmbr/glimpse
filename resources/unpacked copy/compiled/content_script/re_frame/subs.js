...
var args15244 = [];
var len__7278__auto___15259 = arguments.length;
var i__7279__auto___15260 = (0);
while(true){
if((i__7279__auto___15260 < len__7278__auto___15259)){
args15244.push((arguments[i__7279__auto___15260]));

var G__15261 = (i__7279__auto___15260 + (1));
i__7279__auto___15260 = G__15261;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args15244.length)].join('')));
...
var handler_fn = cljs.core.get.call(null,cljs.core.deref.call(null,re_frame.subs.key__GT_fn),key_v);
if(goog.DEBUG){
var temp__4657__auto___15267 = cljs.core.seq.call(null,cljs.core.remove.call(null,((function (key_v,handler_fn){
return (function (p1__15243_SHARP_){
if(!((p1__15243_SHARP_ == null))){
if((false) || (p1__15243_SHARP_.reagent$ratom$IReactiveAtom$)){
return true;
} else {
return false;
}
...
,dynv));
if(temp__4657__auto___15267){
var not_reactive_15268 = temp__4657__auto___15267;
re_frame.utils.warn.call(null,"re-frame: dynv contained parameters that don't implement IReactiveAtom: ",not_reactive_15268);
} else {
}
} else {
}

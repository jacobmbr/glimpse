...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__6814__auto__,writer__6815__auto__,opt__6816__auto__){
return cljs.core._write.call(null,writer__6815__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__14154 = o;
(G__14154[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__14155__delegate = function (args){
...
var args = cljs.core.seq(arglist__14157);
...
if(cljs.core.truth_((function (){var and__6196__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__6196__auto__){
var and__6196__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__6196__auto____$1){
var and__6196__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__14171 = jsprops;
(G__14171["defaultValue"] = value);

(G__14171["onChange"] = ((function (G__14171,v,value,on_change){
return (function (p1__14165_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__14165_SHARP_);
});})(G__14171,v,value,on_change))
);
...
var vec__14180 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__14180,(0),null);
var id = cljs.core.nth.call(null,vec__14180,(1),null);
var class$ = cljs.core.nth.call(null,vec__14180,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___14192 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___14192 == null)){
} else {
var key_14193 = temp__4661__auto___14192;
(jsprops["key"] = key_14193);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__14195 = (new reagent.impl.template.NativeWrapper());
(G__14195["name"] = c);
...
var len__7278__auto___14212 = arguments.length;
var i__7279__auto___14213 = (0);
while(true){
if((i__7279__auto___14213 < len__7278__auto___14212)){
args__7285__auto__.push((arguments[i__7279__auto___14213]));

var G__14214 = (i__7279__auto___14213 + (1));
i__7279__auto___14213 = G__14214;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7286__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq14210){
var G__14211 = cljs.core.first.call(null,seq14210);
var seq14210__$1 = cljs.core.next.call(null,seq14210);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__14211,seq14210__$1);
});
...
break;
default:
var G__14241 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__14241;
continue;
...
var n__7123__auto___14242 = a.length;
var i_14243 = (0);
while(true){
if((i_14243 < n__7123__auto___14242)){
(a[i_14243] = reagent.impl.template.as_element.call(null,(a[i_14243])));
...
var a = cljs.core.into_array.call(null,s);
var n__7123__auto___14248 = a.length;
var i_14249 = (0);
while(true){
if((i_14249 < n__7123__auto___14248)){
var val_14250 = (a[i_14249]);
if((cljs.core.vector_QMARK_.call(null,val_14250)) && ((reagent.impl.template.key_from_vec.call(null,val_14250) == null))){
(o["no-key"] = true);
} else {
}

(a[i_14249] = reagent.impl.template.as_element.call(null,val_14250));

var G__14252 = (i_14249 + (1));
i_14249 = G__14252;
continue;
} else {
}
...
var ctx = {};
var vec__14255 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__14255,(0),null);
var derefed = cljs.core.nth.call(null,vec__14255,(1),null);
...
var G__14257 = (cljs.core.count.call(null,argv) - first_child);
switch (G__14257) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__14257){

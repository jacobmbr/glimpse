...
var this$__$1 = this;
if((message == null)){
var config__8759__auto__ = self__.config;
var handler_key__8760__auto__ = new cljs.core.Keyword(null,"chrome-port-post-message-called-with-nil","chrome-port-post-message-called-with-nil",864934312);
...
return handler__8761__auto__.call(null,config__8759__auto__,this$__$1);
} else {
if(cljs.core.truth_(self__.connected_QMARK_)){
var o__8728__auto__ = self__.native_chrome_port;
return goog.object.get(o__8728__auto__,"postMessage").call(o__8728__auto__,message);
} else {
var config__8759__auto__ = self__.config;
var handler_key__8760__auto__ = new cljs.core.Keyword(null,"chrome-port-post-message-called-on-disconnected-port","chrome-port-post-message-called-on-disconnected-port",-1329006944);
var handler__8761__auto__ = handler_key__8760__auto__.call(null,config__8759__auto__);
if(cljs.core.fn_QMARK_.call(null,handler__8761__auto__)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("invalid "),cljs.core.str(handler_key__8760__auto__),cljs.core.str(" in chromex config\n"),cljs.core.str("config: "),cljs.core.str(config__8759__auto__)].join('')),cljs.core.str("\n"),cljs.core.str("(clojure.core/fn? handler__8761__auto__)")].join('')));
...
if(cljs.core.truth_(self__.connected_QMARK_)){
var o__8728__auto__ = self__.native_chrome_port;
return goog.object.get(o__8728__auto__,"disconnect").call(o__8728__auto__);
} else {
var config__8759__auto__ = self__.config;
var handler_key__8760__auto__ = new cljs.core.Keyword(null,"chrome-port-disconnect-called-on-disconnected-port","chrome-port-disconnect-called-on-disconnected-port",-1526797777);
var handler__8761__auto__ = handler_key__8760__auto__.call(null,config__8759__auto__);
if(cljs.core.fn_QMARK_.call(null,handler__8761__auto__)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("invalid "),cljs.core.str(handler_key__8760__auto__),cljs.core.str(" in chromex config\n"),cljs.core.str("config: "),cljs.core.str(config__8759__auto__)].join('')),cljs.core.str("\n"),cljs.core.str("(clojure.core/fn? handler__8761__auto__)")].join('')));
...
var o__8728__auto__ = on_disconnect_event;
return goog.object.get(o__8728__auto__,"addListener").call(o__8728__auto__,callback);
} else {
var config__8759__auto__ = self__.config;
var handler_key__8760__auto__ = new cljs.core.Keyword(null,"chrome-port-on-disconnect-called-on-disconnected-port","chrome-port-on-disconnect-called-on-disconnected-port",-269858172);
var handler__8761__auto__ = handler_key__8760__auto__.call(null,config__8759__auto__);
if(cljs.core.fn_QMARK_.call(null,handler__8761__auto__)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("invalid "),cljs.core.str(handler_key__8760__auto__),cljs.core.str(" in chromex config\n"),cljs.core.str("config: "),cljs.core.str(config__8759__auto__)].join('')),cljs.core.str("\n"),cljs.core.str("(clojure.core/fn? handler__8761__auto__)")].join('')));
...
var o__8728__auto__ = on_message_event;
return goog.object.get(o__8728__auto__,"addListener").call(o__8728__auto__,callback);
} else {
var config__8759__auto__ = self__.config;
var handler_key__8760__auto__ = new cljs.core.Keyword(null,"chrome-port-on-message-called-on-disconnected-port","chrome-port-on-message-called-on-disconnected-port",1590595021);
var handler__8761__auto__ = handler_key__8760__auto__.call(null,config__8759__auto__);
if(cljs.core.fn_QMARK_.call(null,handler__8761__auto__)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("invalid "),cljs.core.str(handler_key__8760__auto__),cljs.core.str(" in chromex config\n"),cljs.core.str("config: "),cljs.core.str(config__8759__auto__)].join('')),cljs.core.str("\n"),cljs.core.str("(clojure.core/fn? handler__8761__auto__)")].join('')));
...
var config__8759__auto__ = self__.config;
var handler_key__8760__auto__ = new cljs.core.Keyword(null,"chrome-port-put-message-called-on-disconnected-port","chrome-port-put-message-called-on-disconnected-port",1479634211);
var handler__8761__auto__ = handler_key__8760__auto__.call(null,config__8759__auto__);
if(cljs.core.fn_QMARK_.call(null,handler__8761__auto__)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("invalid "),cljs.core.str(handler_key__8760__auto__),cljs.core.str(" in chromex config\n"),cljs.core.str("config: "),cljs.core.str(config__8759__auto__)].join('')),cljs.core.str("\n"),cljs.core.str("(clojure.core/fn? handler__8761__auto__)")].join('')));
...
return handler__8761__auto__.call(null,config__8759__auto__,this$__$1,message);
}
});
...
chromex.chrome_port.ChromePort.cljs$lang$ctorPrWriter = (function (this__6814__auto__,writer__6815__auto__,opt__6816__auto__){
return cljs.core._write.call(null,writer__6815__auto__,"chromex.chrome-port/ChromePort");
});
...
var channel = (function (){var config__8759__auto__ = config;
var handler_key__8760__auto__ = new cljs.core.Keyword(null,"chrome-port-channel-factory","chrome-port-channel-factory",393485192);
var handler__8761__auto__ = handler_key__8760__auto__.call(null,config__8759__auto__);
if(cljs.core.fn_QMARK_.call(null,handler__8761__auto__)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("invalid "),cljs.core.str(handler_key__8760__auto__),cljs.core.str(" in chromex config\n"),cljs.core.str("config: "),cljs.core.str(config__8759__auto__)].join('')),cljs.core.str("\n"),cljs.core.str("(clojure.core/fn? handler__8761__auto__)")].join('')));
...
chromex.protocols.on_message_BANG_.call(null,chrome_port,(function (){var config__8759__auto__ = config;
var handler_key__8760__auto__ = new cljs.core.Keyword(null,"chrome-port-on-message-fn-factory","chrome-port-on-message-fn-factory",1295000398);
var handler__8761__auto__ = handler_key__8760__auto__.call(null,config__8759__auto__);
if(cljs.core.fn_QMARK_.call(null,handler__8761__auto__)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("invalid "),cljs.core.str(handler_key__8760__auto__),cljs.core.str(" in chromex config\n"),cljs.core.str("config: "),cljs.core.str(config__8759__auto__)].join('')),cljs.core.str("\n"),cljs.core.str("(clojure.core/fn? handler__8761__auto__)")].join('')));
...
chromex.protocols.on_disconnect_BANG_.call(null,chrome_port,(function (){var config__8759__auto__ = config;
var handler_key__8760__auto__ = new cljs.core.Keyword(null,"chrome-port-on-disconnect-fn-factory","chrome-port-on-disconnect-fn-factory",-501244675);
var handler__8761__auto__ = handler_key__8760__auto__.call(null,config__8759__auto__);
if(cljs.core.fn_QMARK_.call(null,handler__8761__auto__)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("invalid "),cljs.core.str(handler_key__8760__auto__),cljs.core.str(" in chromex config\n"),cljs.core.str("config: "),cljs.core.str(config__8759__auto__)].join('')),cljs.core.str("\n"),cljs.core.str("(clojure.core/fn? handler__8761__auto__)")].join('')));

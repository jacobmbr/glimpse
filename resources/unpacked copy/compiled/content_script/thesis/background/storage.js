...
return cljs_idxdb.core.create_db.call(null,"requestsDB",(1),(function (p1__10544_SHARP_){
var store = cljs_idxdb.core.delete_and_create_store.call(null,p1__10544_SHARP_,thesis.background.storage.store_name,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"keyPath","keyPath",-1845944323),"timestamp"], null));
...
return cljs.core.set.call(null,cljs.core.conj.call(null,cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,p1__10551_SHARP_),domain));
...
return cljs_idxdb.core.get_by_index.call(null,cljs.core.deref.call(null,thesis.background.storage.db),thesis.background.storage.store_name,"domainIndex",domain,(function (p1__10552_SHARP_){
return cb.call(null,cljs.core.clj__GT_js.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"count-res",new cljs.core.Keyword(null,"domain","domain",1847214937),domain,new cljs.core.Keyword(null,"count","count",2139924085),cljs.core.count.call(null,p1__10552_SHARP_)], null)));
}));
});
...
return cljs.core.async.put_BANG_.call(null,res_chan,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"restype","restype",1458513241),"all-for-domain",new cljs.core.Keyword(null,"typ","typ",-1304536900),typ,new cljs.core.Keyword(null,"domain","domain",1847214937),domain,new cljs.core.Keyword(null,"data","data",-232669377),p1__10554_SHARP_], null));
});})(req))
);
});
...
,cljs.core.PersistentVector.EMPTY,p1__10555_SHARP_)));
});})(req))
);
});
...
,cljs.core.PersistentArrayMap.EMPTY,p1__10556_SHARP_)));
});})(req))
);
});
thesis.background.storage.get_location_counts = (function thesis$background$storage$get_location_counts(res_chan){
return thesis.background.storage.get_distinct_index_with_counts.call(null,"locationIndex",new cljs.core.Keyword(null,"location","location",1815599388),(function (p1__10557_SHARP_){
...
}),cljs.core.PersistentArrayMap.EMPTY,p1__10557_SHARP_);
...
return thesis.background.storage.get_distinct_index.call(null,"locationIndex",new cljs.core.Keyword(null,"location","location",1815599388),(function (p1__10558_SHARP_){
return cljs.core.async.put_BANG_.call(null,res_chan,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"restype","restype",1458513241),"distinct-locations",new cljs.core.Keyword(null,"data","data",-232669377),p1__10558_SHARP_], null));
}));
});
thesis.background.storage.get_distinct_domains = (function thesis$background$storage$get_distinct_domains(res_chan){
return thesis.background.storage.get_distinct_index_with_counts.call(null,"domainIndex",new cljs.core.Keyword(null,"domain","domain",1847214937),(function (p1__10559_SHARP_){
return cljs.core.async.put_BANG_.call(null,res_chan,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"restype","restype",1458513241),"distinct-domains",new cljs.core.Keyword(null,"data","data",-232669377),p1__10559_SHARP_], null));
}));
});

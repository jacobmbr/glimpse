...
var reader = (function (){var or__18417__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__18417__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__18417__auto__)){
return or__18417__auto__;
} else {
return (128);
...
var map__41470 = top_item;
var map__41470__$1 = ((((!((map__41470 == null)))?((((map__41470.cljs$lang$protocol_mask$partition0$ & (64))) || (map__41470.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__41470):map__41470);
var file = cljs.core.get.call(null,map__41470__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__41470__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__41470__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.sanity_hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e41469){var _e = e41469;
return false;
}});
devtools.sanity_hints.type_error_to_string = (function devtools$sanity_hints$type_error_to_string(self){
var temp__4655__auto___41472 = devtools.sanity_hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___41472)){
var seen_errors_41473 = temp__4655__auto___41472;
if(cljs.core.truth_(seen_errors_41473.has(self))){
} else {
seen_errors_41473.add(self);

var temp__4657__auto___41474 = devtools.sanity_hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___41474)){
var sense_41475 = temp__4657__auto___41474;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_41475)].join('');
} else {
}
}
} else {
...
if(cljs.core.truth_((function (){var and__18405__auto__ = cljs.core.not.call(null,devtools.sanity_hints._STAR_installed_QMARK__STAR_);
